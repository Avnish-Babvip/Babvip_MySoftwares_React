...
const Style1 = ({ data: styleData }) => {
  ...
  const data =
    Array.isArray(styleSoftware) && selectedCategory !== "All"
      ? styleSoftware.find((item) => item.category_name === selectedCategory) ||
        styleSoftware[0]
      : allData;
                    ...
                    <div class="row software-container">
                      ...
                      data?.softwares.length > 0 ? (
                        data?.softwares.map((software, idx) => (
                          ...
                          >
                            <div
                              className="position-relative text-decoration-none connected-app-single border border-2 promo-border-hover mt-4 transition-base bg-white rounded-custom d-block overflow-hidden p-4 w-100 d-flex flex-column justify-content-between"
