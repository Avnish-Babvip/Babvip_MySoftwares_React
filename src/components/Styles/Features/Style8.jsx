...
const Style8 = ({data}) => {
  return (
<section class="feature-section ptb-60 bg-light-subtle">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            {data?.step_data?.map((item,idx)=>(              <div class="feature-card border border-light border-2 bg-white rounded-custom p-5">
