        ...
        <div class="container my-4">
          <div class="row">
            <div class="col-md-8">
              ...
              <p>
                <b>
                  Total Records: {data?.total} Showing {data?.per_page} records
                  per page
                </b>
              </p>
            </div>
            <div class="col-md-4 text-end">
              ...
              <div class="dropdown d-inline-block">
                ...
                <ul class="dropdown-menu" aria-labelledby="sortingDropdown">
                  <li>
                    <a
                      class="dropdown-item software_sort"
                      onClick={() =>
                        slug
                          ? setUrl(
                              `${
                                import.meta.env
                                  .VITE_REACT_APP_API_BASE_URL_PRODUCTION
              ...
              <nav aria-label="Page navigation example" class=" ">
                <ul class="pagination">
                  {Array.isArray(data?.links) && (
                    <li
                      class={`page-item ${!data?.links[0]?.url && "disabled"}`}
                      onClick={() =>
                  ...
                  {Array.isArray(data?.links) && (
                    <li
                      ...
                      onClick={() =>
                        data?.links.slice(-1)[0]?.url &&
                        setUrl(data?.links.slice(-1)[0]?.url)
                      }
                    >
                      <span class="page-link">
                        {" "}
