...
import FilterModal from '../CategoryModal/FilterModal';

const SoftwarePagination = ({data,setUrl,slug,software_category}) => {
  ...
  return (
     ...
     <section class="feature-promo">
              <div class="container mb-4">
                <div class="row">
                  <div class="col-md-8">
                   {software_category ? <h4>Our Best { software_category?.category_name}</h4>:<div className='mt-2'></div>}
                    <p>
                      <b>
                  ...
                  <div class="col-md-4 text-end">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="sortingDropdown">
                          <li>
                            <a class="dropdown-item software_sort" onClick={()=> slug ? setUrl( `${
          import.meta.env.VITE_REACT_APP_API_BASE_URL_PRODUCTION
        }/site/categoryallsoftware/${slug}?sort_by=Newest`) : setUrl( `${
          import.meta.env.VITE_REACT_APP_API_BASE_URL_PRODUCTION
        }/site/softwarestyle2?sort_by=Newest`)}>
                              Newest
                            </a>
                          </li>
                          ...
                          <li>
                            <a class="dropdown-item software_sort"  onClick={()=> slug ? setUrl( `${
          import.meta.env.VITE_REACT_APP_API_BASE_URL_PRODUCTION
        }/site/categoryallsoftware/${slug}?sort_by=Oldest`) :setUrl( `${
          import.meta.env.VITE_REACT_APP_API_BASE_URL_PRODUCTION
        }/site/softwarestyle2?sort_by=Oldest`)}>
                              Oldest
                            </a>
                          </li>
                        </ul>
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-md-12 text-center">
                    ...
                    { Array.isArray(data?.links) &&   <li
                          class={`page-item ${
                             !data?.links.slice(-1)[0]?.url && "disabled"
                          }`}
                          onClick={() =>
                            data?.links.slice(-1)[0]?.url && setUrl(data?.links.slice(-1)[0]?.url)
                          }
                        >
                          <span class="page-link">
                            {" "}
                            { data?.links.slice(-1)[0]?.label?.replace("&raquo;", "")}
                          </span>
                        </li>}
                      </ul>
